...
const DocInfo=({route, navigation})=>{
    ...
    renderItem={({item})=>(
       ...
       <TouchableOpacity style={styles._Rectangle_1} onPress={()=> {sendData(id, pid)
    Alert.alert('Added to your doctors')}} >
        <Text style={{color: 'white', fontWeight:'bold', fontSize:SCREEN_WIDTH*30/759, position:"relative",top:9, left:25}}>
						Add as my doctor
					</Text>
			</TouchableOpacity>
</View>
